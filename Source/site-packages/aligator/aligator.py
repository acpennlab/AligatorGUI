...
def package(expt_list=["train", "rec", "relax", "cr"], mech_list=["3"], rate="alpha", power=[1], range = 1, trials = 10, npulse = 50, pulsewidth = 1, pulsefreq = 200):
    """
    ...
    for mech in mech_list:
        ...
        for expt_type in expt_list:
            ...
            e.run(npulse, pulsewidth, pulsefreq)
